...
class FactItemOrdenCompra(models.Model):
    ...
    item_total_linea_neto = models.DecimalField(max_digits=30, decimal_places=8, blank=True, null=True, db_comment='Cantidad por precio neto')
    ...
    class Meta:
        managed = False
        db_table = 'fact_item_orden_compra'
